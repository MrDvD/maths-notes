...
$$(X,\ast_1,\dots,\ast_n)$$
% ---
Структуры $(M,\circ)$, $(N,\ast)$ {\bold изоморфны}, если существует изоморфизм $f$ вида:
% ---
$$\begin{gathered}
...
{\color{desc}\item Полугруппа относительно {\ital умножения} $\cdot$ --- для {\bold ассоциативного кольца}.}
